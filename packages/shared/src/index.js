...
export const slotStatuses = ["available", "held", "booked", "cancelled"];
export const campaignStatuses = ["draft", "running", "paused", "completed", "stopped"];
export const callingProviders = ["mock", "vobiz_sip", "vobiz_api"];
const optionalEmail = z.preprocess((value) => value === "" ? undefined : value, z.string().email().optional().nullable());
